...
void Modulador() {
  ...
  if (RC_Throttle_consigna <= 1300) {
    ...
    if (ESC5_us < 1000) ESC3_us = 950*0.125;
    if (ESC6_us < 1000) ESC4_us = 950*0.125;
  }
  ...
  // Si el throttle es mayor a 1300us, el control de estabilidad se activa.
    ...
    ESC1_us = (RC_Throttle_consigna + PID_W_Pitch_OUT + PID_W_Roll_OUT - PID_W_Yaw_OUT)*0.125; // Motor 5
    ESC2_us = (RC_Throttle_consigna + PID_W_Pitch_OUT - PID_W_Roll_OUT + PID_W_Yaw_OUT)*0.125; // Motor 6
    ...
    if (ESC5_us > 2000) ESC3_us = 2000*0.125;
    if (ESC6_us > 2000) ESC4_us = 2000*0.125;
  }
}
