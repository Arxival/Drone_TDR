...
void setup() {
  ...
  // Para poder avanzar hay que encender el mando y bajar Throttle al mínimo
  digitalWrite(pin_LED_rojo2, HIGH);
  Serial.print("Encender mando");
  if (MODO_vuelo == 1) Serial.print("-MODO Estable-");
