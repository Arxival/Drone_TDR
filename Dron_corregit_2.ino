...
#define pin_LED_rojo2 A2    // Pin LED rojo 2    
...
void setup() {
  ...
  if (visu == 1) {
    ...
    analogWrite(pin_LED_rojo2, 255);
  }

  Serial.println("començem leds");
  // Declaración de LEDs
  pinMode(pin_LED_rojo2, OUTPUT); // Led naranja --> Batería baja
  ...
  pinMode(pin_motor5, OUTPUT);  //Motor 4
  pinMode(pin_motor6, OUTPUT);  //Motor 4
